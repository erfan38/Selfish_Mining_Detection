...
protected:
  ...
  double          m_forkHeight; // New feature: Fork Height
  int             m_forkLength;    // New feature: Fork Length
  int             m_blockInterval; // New feature: Block Interval
  double          m_timeInterval; // New feature: Time Interval
